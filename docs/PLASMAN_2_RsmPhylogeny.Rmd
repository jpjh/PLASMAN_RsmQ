---
title: "2. Phylogenetic analyses of plasmid-borne RsmA"
author: "jpjh"
date: "Nov 2021"
...
I'll deal with this once the sequences have been extracted, by identifying identical sequences within projects. I'll also attempt to identify sequences with less than some threshold divergence, to avoid the problem of multiple sampling.
...
Examined all, and double-checked the source of those genes annotated `unk` and determined whether they are indeed chromosomal. Did some additional editing at this stage to ensure I had the sequences required.
